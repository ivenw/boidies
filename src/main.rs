    ...
    App::new()
        ...
        .add_startup_system_set(
            SystemSet::new()
                ...
                .with_system(setup_bird),
        )
        .add_system_set(
            SystemSet::new()
                .with_run_criteria(FixedTimestep::step(TIME_STEP as f64))
                // .with_system(update_bird_velocity)
                .with_system(move_boid_towards_perceived_scenter_of_mass)
                .with_system(keep_distance_from_boids)
                .with_system(move_boids_to_mouse)
                // .with_system(match_other_boids_velocity)
...
fn setup_bird(mut commands: Commands) {
